...
Note: This instruction set is just a copy-paste from Marie, note that [Hackfreaks](https://t.me/Hackfreaks) allows everyone to use thing repo(originally from Marie, and forked from Saitama). If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
...
class Development(Config):
    OWNER_ID = 1167145475  # your telegram ID
    OWNER_USERNAME = "TheLevinGod"  # your telegram username
    API_KEY = "your bot api key"  # your api key, as provided by the @botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:5432/database'  # sample db credentials
    MESSAGE_DUMP = '-1234567890' # some group chat that your bot is a member of
    USE_MESSAGE_DUMP = True
    SUDO_USERS = [1167145475]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [HackFreaks](https://t.me/hackfreaks)
